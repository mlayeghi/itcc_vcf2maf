...
def searcher(ref_dir_dict: dict, search_dir: Path, tmp_dir: str, out_type: None) -> tuple:
    maf_files = []
    seg_files = []
    for root, dirs, files in os.walk(search_dir, topdown=True,followlinks=False):
        ...
        for file in files:
            ...
            if out_type=='seg' and file.endswith("purple.cnv.somatic.tsv"):
            ...
            elif out_type=='maf' and file.endswith("purple.somatic.vcf.gz"):
            ...
            elif file.endswith((".purple.cnv.somatic.tsv", "purple.somatic.vcf.gz")):
